...
Re-run the seed whenever the scope catalogue has changed: it adds the new scopes to the
`administrator` role, and skipping it leaves administrators unable to reach the endpoints that
require them.
